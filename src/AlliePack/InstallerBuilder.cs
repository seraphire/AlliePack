...
namespace AlliePack
{
    public class InstallerBuilder
    {
        ...
        private static void WriteBuildScript(string exportDir, string safeName, List<string> extensions)
        {
            ...
            string script =
$@"# ------------------------------------------------------------------------------
# AUTO-GENERATED by AlliePack -- do not edit by hand.
# This file is regenerated each time AlliePack exports a WXS artifact; any
# manual changes will be overwritten.
# https://github.com/GreatMigrations/AlliePack
# ------------------------------------------------------------------------------
param(
